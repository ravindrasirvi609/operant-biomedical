        ...
        <div className="container">
          <div className="cs_contact_ms">
            ...
            <div className="cs_contact_section_2 anim_div_ShowRightSide">
              ...
              >
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3524.975124408454!2d73.327797!3d25.789801000000003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjfCsDU5JzM0LjYiTiA3M8KwMjYnMjUuMiJF!5e0!3m2!1sen!2sbd!4v1563075599994!5m2!1sen!2sbd"
              ...
              <div className="row">
                <div className="col-md-4">
                  <div className="cs_icon">
                    ...
                    <div className="cs_icon_text">
                      ...
                      <p className="cs_icon_subtitle">17, Mayank nagar, Pali</p>
                    </div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="cs_icon">
                    <a href="tel:" className="cs_icon_style">
                      <i>
                        <svg
                          width="18"
                          height="19"
                ...
                <div className="col-md-4">
                  <div className="cs_icon">
                    <a href="mailto:admin@opf.org.in" className="cs_icon_style">
                      <i>
                        <svg
                          width="18"
                          height="14"
                    ...
                    <div className="cs_icon_text">
                      ...
                      <p className="cs_icon_subtitle">admin@opf.org.in</p>
                    </div>
                  </div>
                </div>
              </div>
